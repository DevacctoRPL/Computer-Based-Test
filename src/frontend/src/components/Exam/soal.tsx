    ...
    const fetchSoal = async () => {
      try {
        ...
        const responsePertanyaan = await axios.get<Pertanyaan>(
          `https://49kdgk28-7774.asse.devtunnels.ms/api/pertanyaan/${currentQuestionId}`
        );
        ...
        const responseJawaban = await axios.get<Jawaban>(
          `https://49kdgk28-7774.asse.devtunnels.ms/api/jawaban-pertanyaan/${currentQuestionId}`
        );
  ...
  const handleSubmit = async () => {
    try {
      ...
      for (const data of formattedData) {
        await axios.post('https://49kdgk28-7774.asse.devtunnels.ms/api/jawaban-siswa', data);
      }

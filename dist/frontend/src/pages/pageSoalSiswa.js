    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "h-screen" },
            ...
            React.createElement("main", { className: "flex justify-between mt-6 h-[85%]" },
                ...
                React.createElement("div", { className: "flex flex-col w-1/6 bg-purple-100 p-4 space-y-4 my-4 fixed right-0" },
